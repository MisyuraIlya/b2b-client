export const VALIDATION_I18N_CONSTANTS = {
  COMMON: 'commonValidation',
  EMAIL_REQUIRED: 'SHOP_FORM_INPUT_REQUIRED_EMAIL',
  EMAIL_VALID: 'SHOP_FORM_INPUT_INVALID_EMAIL',
  PASSWORD_REQUIRED: 'SHOP_FORM_INPUT_REQUIRED_PASSWORD',
  PASSWORD_MIN_8: 'SHOP_FORM_INPUT_PASSWORD_MIN_8_CHARACTERS',
  PASSWORD_UPPER_AND_LOWERCASE: 'SHOP_FORM_INPUT_PASSWORD_UPPER_AND_LOWERCASE',
  PASSWORD_1_DIGIT: 'SHOP_FORM_INPUT_PASSWORD_ONE_DIGIT',
  PASSWORD_CONFIRM_MATCH: 'SHOP_FORM_INPUT_PASSWORD_CONFIRM_SHOULD_MATCH',
  AGREEMENTS_REQUIRED: 'SHOP_FORM_INPUT_REQUIRED_AGREEMENTS',
  PHONE_VALID: 'phoneValidation',
}
...
export const REGEX_RULES = {
  ...
  AT_LEAST_1_DIGIT:
    /^(?=.*[0-9²-³¹¼-¾٠-٩۰-۹߀-߉०-९০-৯৴-৹੦-੯૦-૯୦-୯௦-௲౦-౯౸-౾೦-೯൦-൵๐-๙໐-໙༠-༳၀-၉႐-႙፩-፼\u16ee-\u16f0០-៩៰-៹᠐-᠙᥆-᥏᧐-᧙᭐-᭙᮰-᮹᱀-᱉᱐-᱙⁰⁴-⁹₀-₉⅓-\u2182\u2185-\u2188①-⒛⓪-⓿❶-➓⳽\u3007\u3021-\u3029\u3038-\u303a㆒-㆕㈠-㈩㉑-㉟㊀-㊉㊱-㊿꘠-꘩꣐-꣙꤀-꤉꩐-꩙０-９]|\ud800[\udd07-\udd33\udd40-\udd78\udd8a\udf20-\udf23\udf41\udf4a\udfd1-\udfd5]|\ud801[\udca0-\udca9]|\ud802[\udd16-\udd19\ude40-\ude47]|\ud809[\udc00-\udc62]|\ud834[\udf60-\udf71]|\ud835[\udfce-\udfff])/,
}